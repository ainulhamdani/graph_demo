...
import com.highsoft.highcharts.common.hichartsclasses.HILabelOptions;
...
import id.keyta.graphdemo.databinding.FragmentGalleryBinding;
...
public class GalleryFragment extends Fragment {
    ...
    private void setLineChart2() {
        binding.line2.plugins = new ArrayList<>(Arrays.asList("annotations"));
        ...
        chart.setType("area");
        chart.setZoomType("x");
        chart.setPanning(new HIPanning());
        ...
        annotations3.getLabelOptions().setStyle(new HICSSObject());
        ...
        binding.line2.setOptions(options);
    }
    ...
    private void setLineChart() {
        ...
        binding.line.setOptions(options);
    }
    ...
    private void setBarChart() {
        ...
        binding.bar.setOptions(options);
    }
